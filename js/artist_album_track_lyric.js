...
function handleTrackResponse(data) {
    ...
    button_back.innerHTML = "<< Back to album '" + track.album_name + "' by : " + track.artist_name ;

    button_back.onclick = () => {
        location.href = './artist_album_track.html?album_id=' + track.album_id;
    };
